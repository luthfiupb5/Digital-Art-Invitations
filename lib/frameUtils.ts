// Frame path utilities for both sequences

export const SEQ1_TOTAL = 480;
export const SEQ2_TOTAL = 403;
export const SEQ3_TOTAL = 260;
export const TOTAL_FRAMES = SEQ1_TOTAL + SEQ2_TOTAL + SEQ3_TOTAL; // 1143
...
/**
 * Returns the URL path for a given unified frame index [0..1142].
